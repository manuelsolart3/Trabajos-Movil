package com.jhon.basedatoszulema
...
import com.jhon.basedatoszulema.databinding.ActivityMapsTestBinding
...
class MapsActivityTest : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(MarkerOptions().position(sydney).title("Estoy en el SENAA"))
